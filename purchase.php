    ...
    <div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;">
      <div class="container">
        <div id="content-wrap" style="padding-bottom:50px;"> 
          ...
          <form name="donor" action="purchasedata.php" method="post">
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 mb-4">
                <div class="font-italic">Purchase From<span style="color:red">*</span></div>
              ...
              <div class="col-lg-4 mb-4">
                ...
                <div><input type="text" name="yes" class="form-control" ></div>
              </div>
            </div>
