    ...
    <div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;">
      <div class="container">
        <div id="content-wrap" style="padding-bottom:50px;"> 
          ...
          <form name="donor" action="selldata.php" method="post">
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 mb-4">
                <div class="font-italic">Sell To<span style="color:red">*</span></div>
                <div><input type="text" name="sellto" class="form-control" required></div>
              </div>
              <div class="col-lg-4 mb-4">
              ...
              <div class="col-lg-4 mb-4">
                <div class="font-italic">Status<span style="color:red">*</span></div>
                <div><input type="text" name="status" class="form-control" required></div>
              </div>
