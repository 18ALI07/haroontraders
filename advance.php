    ...
    <div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;">
      <div class="container">
        <div id="content-wrap" style="padding-bottom:50px;"> 
          ...
          <form name="customer" action="customerdata.php" method="post">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 mb-4">
                <div class="font-italic">Add Customer Name<span style="color:red">*</span></div>
                <div><input type=" text" name="cust_name" class="form-control" required></div>
              </div>
          ...
          <form name="given" action="advancedata.php" method="post">
          <div class="row">
             

             <div class="col-lg-4 mb-4">
               <div class="font-italic">Name(Given By)<span style="color:red">*</span></div>
               <div><select name="givername" class="form-control" required>
             ...
             <div class="col-lg-4 mb-4">
  <div class="font-italic">Given To<span style="color:red">*</span></div>
  <div><select name="takername" class="form-control" required>
    <option value=""selected disabled>Select</option>
    <?php
      include 'conn.php';
